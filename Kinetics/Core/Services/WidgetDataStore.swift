...
final class WidgetDataStore {
    ...
    // Falls back to standard UserDefaults when App Groups aren't provisioned (free team).
    private let defaults: UserDefaults = UserDefaults(suiteName: "group.com.rayancheca.kinetics") ?? .standard
